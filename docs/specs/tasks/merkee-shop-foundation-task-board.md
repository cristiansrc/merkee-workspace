...
- **Spec canónica:** `/home/cristiansrc/Documentos/Proyectos/merkee-workspace/docs/specs/master_spec.md` (`revision-needed`; no aprobada para nuevo handoff)
